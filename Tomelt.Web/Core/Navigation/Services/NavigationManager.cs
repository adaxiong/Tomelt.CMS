...
namespace Tomelt.Core.Navigation.Services {
    public class NavigationManager : INavigationManager {
        ...
        public IEnumerable<MenuItem> BuildMenu(string menuName) {
            ...
            var hasDebugShowAllMenuItems = _authorizationService.TryCheckAccess(Permission.Named("DebugShowAllMenuItems"), _tomeltServices.WorkContext.CurrentUser, null);
        ...
        private IEnumerable<MenuItem> Reduce(IEnumerable<MenuItem> items, bool isAdminMenu, bool hasDebugShowAllMenuItems) {
            foreach (var item in items.Where(item => 
                ...
                item.Permissions.Any(x => _authorizationService.TryCheckAccess(
                    x, 
                    _tomeltServices.WorkContext.CurrentUser, 
