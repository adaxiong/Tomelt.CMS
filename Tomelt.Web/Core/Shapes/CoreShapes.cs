...
using Tomelt.DisplayManagement.Descriptors.ResourceBindingStrategy;
...
namespace Tomelt.Core.Shapes {
    public class CoreShapes : IShapeTableProvider {
        ...
        public IHtmlString Pager_Links(dynamic Shape, dynamic Display,
            ...
            // specific cross-requests route data can be passed to the shape directly (e.g., Tomelt.Users)
