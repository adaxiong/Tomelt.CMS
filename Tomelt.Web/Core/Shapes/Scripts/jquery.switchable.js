(function ($) {
    $.fn.extend({
        powerUpTheSwitch: function () {
            ...
            var setting = $.tomelt.setting("switchable", { path: document.location.pathname })
        ...
        switchToDetailView: function (switched) {
            $.tomelt.setting("switchable", "detail-view", { path: document.location.pathname });
        ...
        switchToSummaryView: function (switched) {
            $.tomelt.setting("switchable", "summary-view", { path: document.location.pathname });
