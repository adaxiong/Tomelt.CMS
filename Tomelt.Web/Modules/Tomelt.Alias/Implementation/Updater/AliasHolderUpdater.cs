...
using Tomelt.Alias.Implementation.Storage;
...
namespace Tomelt.Alias.Implementation.Updater {
    ...
    public class AliasUpdaterEvent : ITomeltShellEvents
    {
        ...
        void ITomeltShellEvents.Activated() {
            _aliasHolderUpdater.Refresh();
        }

        void ITomeltShellEvents.Terminating() {
        }
    }
}
