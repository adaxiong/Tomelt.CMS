jQuery(function ($) {
    ...
    $("#layout-content").on("tomelt-admin-contentpicker-open", "form", function (ev, data) {
        data = data || {};
        ...
        var url = baseUrl + "/Admin/Tomelt.ContentPicker?";
    ...
    (function() {
        $("fieldset.content-picker-field").each(function() {
            ...
            addButton.click(function() {
                addButton.trigger("tomelt-admin-contentpicker-open", {
