...
namespace Tomelt.Layouts {
    public class Migrations : DataMigrationImpl {
        public int Create() {
            ...
            DefineElementWidget("TextWidget", "Text Widget", "Tomelt.Layouts.Elements.Text");
            DefineElementWidget("MediaWidget", "Media Widget", "Tomelt.Layouts.Elements.MediaItem");
            DefineElementWidget("ContentWidget", "Content Widget", "Tomelt.Layouts.Elements.ContentItem");
