(function ($) {
    var LayoutDesignerHost = function (element, layoutEditor) {
        ...
        this.editElement = function (element) {
            ...
            if (!element.isTemplated) {
                ...
                var dialog = new window.Tomelt.Layouts.Dialog(".dialog-template." + self.settings.editorDialogName);
    ...
    // Export types.
    window.Tomelt = window.Tomelt || {};
    window.Tomelt.Layouts = window.Tomelt.Layouts || {};
    window.Tomelt.Layouts.LayoutDesignerHost = LayoutDesignerHost;
