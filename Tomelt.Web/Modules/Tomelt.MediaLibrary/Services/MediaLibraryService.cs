...
namespace Tomelt.MediaLibrary.Services {
    public class MediaLibraryService : IMediaLibraryService {
        ...
        public IContentQuery<MediaPart, MediaPartRecord> GetMediaContentItems(VersionOptions versionOptions = null) {
            return _tomeltServices.ContentManager.Query<MediaPart, MediaPartRecord>(versionOptions);
        }
        ...
        public IEnumerable<MediaPart> GetMediaContentItems(string folderPath, int skip, int count, string order, string mediaType, VersionOptions versionOptions = null) {
            return BuildGetMediaContentItemsQuery(_tomeltServices.ContentManager, folderPath, order: order, mediaType: mediaType, versionOptions: versionOptions)
                .Slice(skip, count);
        }
        ...
        public IEnumerable<MediaPart> GetMediaContentItemsRecursive(string folderPath, int skip, int count, string order, string mediaType, VersionOptions versionOptions = null) {
            return BuildGetMediaContentItemsQuery(_tomeltServices.ContentManager, folderPath, true, order, mediaType, versionOptions)
                .Slice(skip, count);
        }

        public int GetMediaContentItemsCount(string folderPath, string mediaType, VersionOptions versionOptions = null) {
            return BuildGetMediaContentItemsQuery(_tomeltServices.ContentManager, folderPath, mediaType: mediaType, versionOptions: versionOptions)
                .Count();
        }
        ...
        public int GetMediaContentItemsCountRecursive(string folderPath, string mediaType, VersionOptions versionOptions = null) {
            return BuildGetMediaContentItemsQuery(_tomeltServices.ContentManager, folderPath, true, mediaType: mediaType, versionOptions: versionOptions)
                .Count();
        }
        ...
        public IMediaFolder GetRootMediaFolder() {
            if (_tomeltServices.Authorizer.Authorize(Permissions.ManageMediaContent)) {
                return null;
            }

            if (_tomeltServices.Authorizer.Authorize(Permissions.ManageOwnMedia)) {
                var currentUser = _tomeltServices.WorkContext.CurrentUser;
        ...
        public void RenameFolder(string folderPath, string newFolderName) {
            ...
            try {
                ...
                var mediaParts = BuildGetMediaContentItemsQuery(_tomeltServices.ContentManager, folderPath, true).List();
                foreach (var mediaPart in mediaParts) {
