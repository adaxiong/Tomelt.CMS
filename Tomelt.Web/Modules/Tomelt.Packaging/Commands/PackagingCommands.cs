...
namespace Tomelt.Packaging.Commands {
    [TomeltFeature("PackagingServices")]
    public class PackagingCommands : DefaultTomeltCommandHandler {
    ...
    The default filename is Tomelt.[Module|Theme].<extensionName>.<extensionVersion>.nupkg.
    For example, ""package create SampleModule c:\temp"" will create the package
    ""c:\temp\Tomelt.Module.SampleModule.1.0.0.nupkg"".")]
    ...
    The <packageId> should take the format Tomelt.[Module|Theme].<extensionName>.
    For example, ""package uninstall Tomelt.Module.SampleModule"" will uninstall the Module under the ""~/Modules/SampleModule"" directory and
    ""package uninstall Tomelt.Theme.SampleTheme"" will uninstall the Theme under the ""~/Themes/SampleTheme"" directory.")]
