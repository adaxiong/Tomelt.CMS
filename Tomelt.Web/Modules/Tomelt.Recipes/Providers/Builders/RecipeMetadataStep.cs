...
namespace Tomelt.Recipes.Providers.Builders {
    public class RecipeMetadataStep : RecipeBuilderStep {
        ...
        public RecipeMetadataStep(ITomeltServices tomeltServices) {
        ...
        public override dynamic UpdateEditor(dynamic shapeFactory, IUpdateModel updater) {
            var viewModel = new SetupRecipeStepViewModel {
                RecipeAuthor = _tomeltServices.WorkContext.CurrentUser.UserName
            };
        ...
        public override void Build(BuildContext context) {
            var recipeElement = context.RecipeDocument.Element("Tomelt").Element("Recipe");
