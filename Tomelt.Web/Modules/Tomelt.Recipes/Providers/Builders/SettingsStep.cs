...
namespace Tomelt.Recipes.Providers.Builders {
    public class SettingsStep : RecipeBuilderStep {
        ...
        public SettingsStep(ITomeltServices tomeltServices) {
        ...
        public override void Build(BuildContext context) {
            context.RecipeDocument.Element("Tomelt").Add(ExportSiteSettings());
        }

        private XElement ExportSiteSettings() {
            var siteContentItem = _tomeltServices.WorkContext.CurrentSite.ContentItem;
