...
namespace Tomelt.Resources {
    public class jQuery : IResourceManifestProvider {
        public void BuildManifests(ResourceManifestBuilder builder) {
            ...
            manifest.DefineStyle("jQueryUI_Tomelt").SetDependencies("jQueryUI"); // Right now no customization in the styles, but the resource might be used later.
            ...
            manifest.DefineStyle("jQueryCalendars_Picker").SetUrl("Calendars/jquery.calendars.picker.full.min.css", "Calendars/jquery.calendars.picker.full.css").SetDependencies("jQueryUI_Tomelt").SetVersion("2.0.1");
            ...
            manifest.DefineStyle("jQueryEasyUI").SetUrl("EasyUI/default/easyui.css").SetVersion("1.5.2");
