...
namespace Tomelt.Roles.Commands {
    public class RoleCommands : DefaultTomeltCommandHandler {
        ...
        [TomeltSwitches("WithFeature,WithPermission,IncludeUsers,IncludePermissions")]
