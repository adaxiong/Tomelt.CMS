...
namespace Tomelt.Roles {
    public class RolesDataMigration : DataMigrationImpl {
        ...
        public int UpdateFrom1() {
            ...
            // creates default permissions for Tomelt v1.4 instances and earlier
            _roleService.CreatePermissionForRole("Anonymous", Tomelt.Core.Contents.Permissions.ViewContent.Name);
            _roleService.CreatePermissionForRole("Authenticated", Tomelt.Core.Contents.Permissions.ViewContent.Name);
