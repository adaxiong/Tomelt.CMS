...
namespace Tomelt.Users.Controllers {
    ...
    public class AccountController : Controller {
        ...
        public ActionResult Register() {
            ...
            var shape = _tomeltServices.New.Register();
            return new ShapeResult(this, shape); 
        }
            ...
            if (ValidateRegistration(userName, email, password, confirmPassword)) {
                ...
                if (user != null) {
                    if ( user.As<UserPart>().EmailStatus == UserStatus.Pending ) {
                        var siteUrl = _tomeltServices.WorkContext.CurrentSite.BaseUrl;
        ...
        public ActionResult RequestLostPassword(string username) {
            ...
            _userService.SendLostPasswordEmail(username, nonce => Url.MakeAbsolute(Url.Action("LostPassword", "Account", new { Area = "Tomelt.Users", nonce = nonce }), siteUrl));

            _tomeltServices.Notifier.Information(T("Check your e-mail for the confirmation link."));
