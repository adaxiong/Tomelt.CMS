...
namespace Tomelt.ContentManagement {
    public class DefaultContentManager : IContentManager {
        ...
        public virtual void Destroy(ContentItem contentItem) {
            ...
            session
                .CreateQuery("delete from Tomelt.ContentManagement.Records.ContentItemVersionRecord civ where civ.ContentItemRecord.Id = (:id)")
                .SetParameter("id", contentItem.Id)
                .ExecuteUpdate();

            // Delete the content item record itself.
            session
                .CreateQuery("delete from Tomelt.ContentManagement.Records.ContentItemRecord ci where ci.Id = (:id)")
                .SetParameter("id", contentItem.Id)
                .ExecuteUpdate();
