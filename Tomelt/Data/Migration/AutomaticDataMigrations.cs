...
using Tomelt.Tasks.Locking.Services;
using Tomelt.Exceptions;

namespace Tomelt.Data.Migration {
    /// <summary>
    /// Registers to TomeltShell.Activated in order to run migrations automatically 
    /// </summary>
    public class AutomaticDataMigrations : ITomeltShellEvents {
