...
namespace Tomelt.Data.Migration.Generator {
    public class SchemaCommandGenerator : ISchemaCommandGenerator {
        ...
        public IEnumerable<SchemaCommand> GetCreateFeatureCommands(string feature, bool drop) {
            ...
            var shellDescriptor = new ShellDescriptor {
                Features = dependencies.Select(id => new ShellFeature { Name = id }).Union(new[] { new ShellFeature { Name = feature }, new ShellFeature { Name = "Tomelt.Framework" } })
            };
            ...
            //var features = dependencies.Select(name => new ShellFeature {Name = name}).Union(new[] {new ShellFeature {Name = feature}, new ShellFeature {Name = "Tomelt.Framework"}});
