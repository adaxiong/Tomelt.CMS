...
namespace Tomelt.Data.Providers {
    ...
    public abstract class AbstractDataServicesProvider : IDataServicesProvider {
        ...
        public Configuration BuildConfiguration(SessionFactoryParameters parameters) {
            ...
            config = config.Database(database)
                           ...
                           .ExposeConfiguration(cfg => {
                               ...
                               cfg.EventListeners.LoadEventListeners = new ILoadEventListener[] { new TomeltLoadEventListener() };
        ...
        [Serializable]
        class TomeltLoadEventListener : DefaultLoadEventListener, ILoadEventListener {
