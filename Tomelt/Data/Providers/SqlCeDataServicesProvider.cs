...
namespace Tomelt.Data.Providers {
    public class SqlCeDataServicesProvider : AbstractDataServicesProvider {
        ...
        public SqlCeDataServicesProvider(string dataFolder, string connectionString) {
            ...
            _fileName = Path.Combine(_dataFolder, "Tomelt.sdf");
        }
        ...
        public override IPersistenceConfigurer GetPersistenceConfigurer(bool createDatabase) {
            ...
            persistence = persistence.Driver(typeof(TomeltSqlServerCeDriver).AssemblyQualifiedName);
            return persistence;
        }
        ...
        public class TomeltSqlServerCeDriver : SqlServerCeDriver {
