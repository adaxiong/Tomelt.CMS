...
namespace Tomelt.Data {
    public class SessionConfigurationCache : ISessionConfigurationCache {
        ...
        private Hash ComputeHash() {
            ...
            // Tomelt version, to rebuild the mappings for each new version
            var TomeltVersion = new System.Reflection.AssemblyName(typeof(Tomelt.ContentManagement.ContentItem).Assembly.FullName).Version.ToString();
            hash.AddString(TomeltVersion);
