...
namespace Tomelt.Data
{
    ...
    public abstract class SessionConfigurationEventsWithParameters : ISessionConfigurationEventsWithParameters
    {
        ...
        /// before applying any default Tomelt config settings (alterations, conventions etc.).
        /// </summary>
        ...
        /// Otherwise the cached configuration (mappings.bin file) will be used as long as default Tomelt configuration 
