...
namespace Tomelt.Data {
    ...
    public class TransactionManager : ITransactionManager, IDisposable {
        ...
        class TomeltSessionInterceptor : IInterceptor {
            private readonly ISessionInterceptor[] _interceptors;
            private readonly ILogger _logger;

            public TomeltSessionInterceptor(ISessionInterceptor[] interceptors, ILogger logger) {
                _interceptors = interceptors;
                _logger = logger;
            }
            ...
            private static bool IsLogged(Exception ex) {
                return ex is TomeltSecurityException || !ex.IsFatal();
            }
        }
    }
}