...
namespace Tomelt.Environment.AutofacUtil.DynamicProxy2 {
    public class DynamicProxyContext {
        const string ProxyContextKey = "Tomelt.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.ProxyContextKey";
        const string InterceptorServicesKey = "Tomelt.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.InterceptorServicesKey";
