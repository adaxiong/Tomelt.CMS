...
namespace Tomelt.Environment {
    ...
    public class DefaultTomeltHostContainer : ITomeltHostContainer, IDependencyResolver {
        private readonly IContainer _container;


        public DefaultTomeltHostContainer(IContainer container) {
        ...
        TService ITomeltHostContainer.Resolve<TService>() {
