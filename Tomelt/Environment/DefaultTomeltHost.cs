...
namespace Tomelt.Environment {
    // All the event handlers that DefaultTomeltHost implements have to be declared in TomeltStarter.
    public class DefaultTomeltHost : ITomeltHost, IShellSettingsManagerEventHandler, IShellDescriptorManagerEventHandler {
        ...
        public DefaultTomeltHost(
            ...
            _tenantsToRestart = new ContextState<IList<ShellSettings>>("DefaultTomeltHost.TenantsToRestart", () => new List<ShellSettings>());
        ...
        void ITomeltHost.Initialize() {
            Logger.Information("Initializing");
            BuildCurrent();
            Logger.Information("Initialized");
        }

        void ITomeltHost.ReloadExtensions() {
            DisposeShellContext();
        }

        void ITomeltHost.BeginRequest() {
            Logger.Debug("BeginRequest");
            BeginRequest();
        }

        void ITomeltHost.EndRequest() {
            Logger.Debug("EndRequest");
            EndRequest();
        }

        IWorkContextScope ITomeltHost.CreateStandaloneEnvironment(ShellSettings shellSettings) {
        ...
        private void MonitorExtensions() {
            ...
            _cacheManager.Get("TomeltHost_Extensions", true,
                              ctx => {
