    ...
    public class ExtensionLoaderCoordinator : IExtensionLoaderCoordinator {
        ...
        private ExtensionLoadingContext CreateLoadingContext() {
            ...
            if (duplicates.Any()) {
                ...
                sb.Append(T("There are multiple extensions with the same name installed in this instance of Tomelt.\r\n"));
                ...
                throw new TomeltException(new LocalizedString(sb.ToString()));
            }
