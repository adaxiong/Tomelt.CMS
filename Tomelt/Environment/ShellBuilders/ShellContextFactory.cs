...
namespace Tomelt.Environment.ShellBuilders {
    ...
    public interface IShellContextFactory {
        ...
        /// <summary>
        /// Builds a shell context for an uninitialized Tomelt instance. Needed
    ...
    public class ShellContextFactory : IShellContextFactory {
        ...
        public ShellContext CreateShellContext(ShellSettings settings) {           
            ...
            return new ShellContext {
                ...
                Shell = shellScope.Resolve<ITomeltShell>(),
            };
        }
        ...
        private static ShellDescriptor MinimumShellDescriptor() {
            return new ShellDescriptor {
                SerialNumber = -1,
                Features = new[] {
                    new ShellFeature {Name = "Tomelt.Framework"},
        ...
        public ShellContext CreateSetupContext(ShellSettings settings) {
            ...
            var descriptor = new ShellDescriptor {
                SerialNumber = -1,
                Features = new[] {
                    new ShellFeature { Name = "Tomelt.Setup" },
                    new ShellFeature { Name = "Shapes" },
                    new ShellFeature { Name = "Tomelt.Resources" }
                },
            };
