...
namespace Tomelt.Environment {
    /// <summary>
    /// Provides ability to connect Shims to the TomeltHostContainer
    /// </summary>
    public static class TomeltHostContainerRegistry {
        private static readonly IList<Weak<IShim>> _shims = new List<Weak<IShim>>();
        private static ITomeltHostContainer _hostContainer;
        ...
        public static void RegisterHostContainer(ITomeltHostContainer container) {
            lock (_syncLock) {
                CleanupShims();
