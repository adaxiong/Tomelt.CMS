...
namespace Tomelt.Localization.Services {
    public class DefaultLocalizedStringManager : ILocalizedStringManager {
        ...
        const string CoreLocalizationFilePathFormat = "~/Core/App_Data/Localization/{0}/tomelt.core.po";
        const string ModulesLocalizationFilePathFormat = "{0}/App_Data/Localization/{1}/tomelt.module.po";
        const string ThemesLocalizationFilePathFormat = "{0}/App_Data/Localization/{1}/tomelt.theme.po";
        const string RootLocalizationFilePathFormat = "~/App_Data/Localization/{0}/tomelt.root.po";
        const string TenantLocalizationFilePathFormat = "~/App_Data/Sites/{0}/Localization/{1}/tomelt.po";
        ...
        // "~/Core/App_Data/Localization/<culture_name>/tomelt.core.po";
        // "~/Modules/<module_name>/App_Data/Localization/<culture_name>/tomelt.module.po";
        // "~/Themes/<theme_name>/App_Data/Localization/<culture_name>/tomelt.theme.po";
        // "~/App_Data/Localization/<culture_name>/tomelt.root.po";
        // "~/App_Data/Sites/<tenant_name>/Localization/<culture_name>/tomelt.po";
