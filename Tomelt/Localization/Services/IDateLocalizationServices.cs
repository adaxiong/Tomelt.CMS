...
namespace Tomelt.Localization.Services {
    ...
    /// <summary>
    /// Provides conversion and formatting of dates according to the Tomelt configured
    ...
    public interface IDateLocalizationServices : IDependency {
        ...
        /// <summary>
        /// Converts a date from UTC to the Tomelt configured time zone.
        /// </summary>
        ...
        /// <summary>
        /// Converts a date from the Tomelt configured time zone to UTC.
        /// </summary>
        ...
        /// <summary>
        /// Converts a date from Gregorian calendar to the Tomelt configured calendar.
        /// </summary>
        ...
        /// <summary>
        /// Converts a date from the Tomelt configured calendar to Gregorian calendar.
        /// </summary>
        /// <param name="parts">A <c>DateTimeParts</c> instance representing the Tomelt configured calendar date to convert.</param>
