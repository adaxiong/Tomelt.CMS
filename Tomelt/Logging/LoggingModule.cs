...
namespace Tomelt.Logging {
    ...
    public class LoggingModule : Module {
        ...
        protected override void Load(ContainerBuilder moduleBuilder) {
            // by default, use Tomelt's logger that delegates to Castle's logger factory
            moduleBuilder.RegisterType<CastleLoggerFactory>().As<ILoggerFactory>().InstancePerLifetimeScope();
            moduleBuilder.RegisterType<TomeltLog4netFactory>().As<Castle.Core.Logging.ILoggerFactory>().InstancePerLifetimeScope();
