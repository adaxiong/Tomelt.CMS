...
namespace Tomelt.Mvc.ViewEngines.Razor {
    ...
    public abstract class WebViewPage<TModel> : System.Web.Mvc.WebViewPage<TModel>, ITomeltViewPage {
        ...
        public TomeltTagBuilder Tag(dynamic shape, string tagName) {
