...
namespace Tomelt.Owin {
    /// <summary>
    /// An Owin middleware registration that can make changes to the Owin pipeline, like registering middlewares to be injected into the Tomelt 
    /// Owin pipeline.
    /// </summary>
