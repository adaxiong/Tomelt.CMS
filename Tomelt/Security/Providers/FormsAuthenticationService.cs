...
namespace Tomelt.Security.Providers {
    public class FormsAuthenticationService : IAuthenticationService {
        ...
        // user name not mapped to an actual Tomelt user content item. If the request is
        ...
        // remember if the current user is a non-Tomelt user between invocations.
        private bool _isNonTomeltUser;
