...
namespace Tomelt.Wcf {
    public class TomeltDependencyInjectionServiceBehavior : IServiceBehavior {
        private readonly IWorkContextAccessor _workContextAccessor;
        private readonly Type _implementationType;
        private readonly IComponentRegistration _componentRegistration;

        public TomeltDependencyInjectionServiceBehavior(IWorkContextAccessor workContextAccessor, Type implementationType, IComponentRegistration componentRegistration) {
        ...
        public void ApplyDispatchBehavior(ServiceDescription serviceDescription, ServiceHostBase serviceHostBase) {
            ...
            TomeltInstanceProvider provider = new TomeltInstanceProvider(this._workContextAccessor, this._componentRegistration);
