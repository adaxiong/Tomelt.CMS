...
namespace Tomelt.Wcf {
    public class TomeltServiceHostFactory : ServiceHostFactory, IShim {
        ...
        public override ServiceHostBase CreateServiceHost(string constructorString, Uri[] baseAddresses) {
            ...
            ITomeltHost tomeltHost = HostContainer.Resolve<ITomeltHost>();
            ShellContext shellContext = tomeltHost.GetShellContext(shellSettings);
