...
using Tomelt.WebApi.Extensions;

namespace Tomelt.WebApi {
    public class DefaultTomeltWebApiHttpControllerSelector : DefaultHttpControllerSelector, IHttpControllerSelector {
        private readonly HttpConfiguration _configuration;

        public DefaultTomeltWebApiHttpControllerSelector(HttpConfiguration configuration) : base(configuration) {
        ...
        public override HttpControllerDescriptor SelectController(HttpRequestMessage request) {
            ...
            // Determine the area name for the request, and fall back to stock tomelt controllers
