...
namespace Tomelt.WebApi {
    public class DefaultTomeltWebApiHttpControllerActivator : IHttpControllerActivator {
        private readonly HttpConfiguration _configuration;

        public DefaultTomeltWebApiHttpControllerActivator(HttpConfiguration configuration)
            : base() {
